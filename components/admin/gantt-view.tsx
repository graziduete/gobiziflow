...
export function GanttView({ projects, allProjects, companies = [], selectedMonth, selectedYear, userRole }: GanttViewProps) {
  ...
  // Ordenação para a lista principal (não expandida - apenas 5 projetos)
  ...
  useEffect(() => {
    ...
    if (isExpanded) {
      ...
      // Na view normal, carregar tasks dos 5 projetos principais
      sortedMainProjects.forEach(project => {
        fetchProjectTasks(project.id)
      })
    }
  }, [projects, expandedFilters, isExpanded])
