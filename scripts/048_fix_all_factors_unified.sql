-- Script unificado para corrigir TODOS os fatores
-- Funciona em qualquer cliente SQL (não usa comandos \i)
...
-- ========================================
-- UIPATH - Fatores corrigidos (PROBLEMA ESPECÍFICO)
-- ========================================
...
-- ========================================
-- VERIFICAÇÃO FINAL - UIPATH > MB (PROBLEMA ESPECÍFICO)
-- ========================================
SELECT 
  'UIPATH > MB CORRIGIDO' as status,
